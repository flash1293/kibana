...
interface BatchResponse<T extends SavedObjectAttributes = any> {
  savedObjects: Array<RawSavedObject<T>>;
}
...
interface BatchQueueEntry {
  type: string;
  id: string;
  resolve: <T extends SavedObjectAttributes>(value: RawSavedObject<T> | PlainSavedObject<T>) => void;
...
export class SavedObjectsClient {
  ...
  private createSavedObject<T extends SavedObjectAttributes>(
    ...
    return new RawSavedObject(this, options);
  }

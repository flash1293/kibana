...
import { datatableVisualizationSetup as treeVisualizationSetup } from '../tree_visualization_plugin';
...
export class AppPlugin {
  ...
  setup() {
    ...
    editorFrame.registerVisualization('tree', treeVisualizationSetup);
